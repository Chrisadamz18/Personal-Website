...
export const projects = [
  {
    id: "eve-ecosystem",
    title: "EVE — Empowering Women Through a Connected Ecosystem",
    category: "UI/UX & Product Design",
    problem: "Women looking to advance careers or scale businesses face fragmented resources across separate platforms for mentorship, commerce, event coordination, and emotional well-being.",
    goal: "Design a multi-faceted digital ecosystem combining professional growth, financial assets, commerce, and mental well-being into a single cohesive mobile experience.",
    role: "UI/UX Designer",
    ...
    timeline: "Nov 2023",
    deliverables: ["User Research", "Information Architecture", "Figma Components", "Interactive Prototype"],
    longDescription: "EVE Women is a multi-faceted digital ecosystem designed to provide social support, mental health networks, professional networking, and financial literacy tools for women. It unifies distinct user journeys into a single, cohesive, and intuitive mobile experience. The platform acts as a secure space focusing on four core pillars: Professional Growth, Financial & Learning Assets, a Commerce Ecosystem, and Empathetic Mental Health Support.",
    challenges: "Combining separate journeys (marketplace, mentorship, ticketing, mental health) without overwhelming the interface required strict information architecture. We addressed this by designing structured onboarding flows, an algorithmic mentorship match system, and soft UI elements to prioritize safety and minimal visual noise.",
    lessons: "Designing for highly vulnerable interactions (like mental health support) necessitates an approachable, calm portal. We learned that separating complex functions into distinct modular dashboards—like the event organizer view and mentorship tracker—prevents cognitive overload while maintaining engagement.",
    types: ["design", "mobile"],
  },
  {
    id: "bloom-healthcare",
    title: "Bloom Haven — Sexual and Mental Healthcare Platform",
    category: "Mobile App & UX Strategy",
    problem: "Access to private, verified sexualand mental wellness and healthcare resources is limited, stigmatized, and frequently gated by high data costs in emerging regions.",
    ...
    process: "Low-bandwidth user flows, localized Figma design system, Flutter interface concept, and FastAPI backend structure.",
  ...
  },
  {
    ...
    timeline: "Aug 2025 — Nov 2025 (3 Months)",
  ...
  },
  {
    ...
    timeline: "March 2026 — April 2026 (2 Months)",
  ...
  },
  {
    ...
    role: "Lead Mobile App Developer & UX Strategist",
    ...
    types: ["mobile", "design","android","ios"],
  },
] as const;
